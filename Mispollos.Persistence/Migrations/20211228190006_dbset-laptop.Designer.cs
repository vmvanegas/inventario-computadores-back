...
namespace Mispollos.Persistence.Migrations
{
    ...
    [Migration("20211228190006_dbset-laptop")]
    partial class dbsetlaptop
    {
            ...
            modelBuilder.Entity("Mispollos.Domain.Entities.Rol", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("947b03ad-eb52-4006-9c4b-eaa6e5c2822b"),
                            CreatedOn = new DateTime(2021, 12, 28, 14, 0, 6, 52, DateTimeKind.Local).AddTicks(3747),
                            Nombre = "Admin",
                            UpdatedOn = new DateTime(2021, 12, 28, 14, 0, 6, 53, DateTimeKind.Local).AddTicks(591)
                        },
                        new
                        {
                            Id = new Guid("7b12e84a-6cfc-46b2-bf95-64999608acfe"),
                            CreatedOn = new DateTime(2021, 12, 28, 14, 0, 6, 53, DateTimeKind.Local).AddTicks(1376),
                            Nombre = "Usuario",
                            UpdatedOn = new DateTime(2021, 12, 28, 14, 0, 6, 53, DateTimeKind.Local).AddTicks(1382)
                        });
                });
