...
namespace Mispollos.Persistence.Migrations
{
    ...
    [Migration("20211229185226_ram-and-backup-field-added-to-laptop-table")]
    partial class ramandbackupfieldaddedtolaptoptable
    {
            ...
            modelBuilder.Entity("Mispollos.Domain.Entities.Rol", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f405a4be-46c1-4bb8-851e-c994273ab139"),
                            CreatedOn = new DateTime(2021, 12, 29, 13, 52, 26, 269, DateTimeKind.Local).AddTicks(7286),
                            Nombre = "Admin",
                            UpdatedOn = new DateTime(2021, 12, 29, 13, 52, 26, 270, DateTimeKind.Local).AddTicks(3354)
                        },
                        new
                        {
                            Id = new Guid("0e338e89-15f1-451c-8b74-af412937cd2b"),
                            CreatedOn = new DateTime(2021, 12, 29, 13, 52, 26, 270, DateTimeKind.Local).AddTicks(4161),
                            Nombre = "Usuario",
                            UpdatedOn = new DateTime(2021, 12, 29, 13, 52, 26, 270, DateTimeKind.Local).AddTicks(4167)
                        });
                });
