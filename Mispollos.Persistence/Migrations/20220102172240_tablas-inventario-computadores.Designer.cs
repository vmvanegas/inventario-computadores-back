...
namespace Mispollos.Persistence.Migrations
{
    ...
    [Migration("20220102172240_tablas-inventario-computadores")]
    partial class tablasinventariocomputadores
    {
            ...
            modelBuilder.Entity("Mispollos.Domain.Entities.Rol", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("9d773913-8f84-42bb-b1af-78445419f69d"),
                            CreatedOn = new DateTime(2022, 1, 2, 12, 22, 40, 384, DateTimeKind.Local).AddTicks(7936),
                            Nombre = "Admin",
                            UpdatedOn = new DateTime(2022, 1, 2, 12, 22, 40, 385, DateTimeKind.Local).AddTicks(3959)
                        },
                        new
                        {
                            Id = new Guid("9548c59c-9a02-4b83-849c-f62e84918012"),
                            CreatedOn = new DateTime(2022, 1, 2, 12, 22, 40, 385, DateTimeKind.Local).AddTicks(4780),
                            Nombre = "Usuario",
                            UpdatedOn = new DateTime(2022, 1, 2, 12, 22, 40, 385, DateTimeKind.Local).AddTicks(4786)
                        });
                });
