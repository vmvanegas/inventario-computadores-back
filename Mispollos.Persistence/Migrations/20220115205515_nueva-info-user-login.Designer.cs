            ...
            modelBuilder.Entity("Mispollos.Domain.Entities.Rol", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("df5c6c2b-dc58-472a-9744-a79b5e928d6b"),
                            CreatedOn = new DateTime(2022, 1, 15, 15, 55, 14, 634, DateTimeKind.Local).AddTicks(5061),
                            Nombre = "Admin",
                            UpdatedOn = new DateTime(2022, 1, 15, 15, 55, 14, 635, DateTimeKind.Local).AddTicks(1454)
                        },
                        new
                        {
                            Id = new Guid("024b38d6-4504-467a-91ce-c56c51b56061"),
                            CreatedOn = new DateTime(2022, 1, 15, 15, 55, 14, 635, DateTimeKind.Local).AddTicks(2345),
                            Nombre = "Usuario",
                            UpdatedOn = new DateTime(2022, 1, 15, 15, 55, 14, 635, DateTimeKind.Local).AddTicks(2350)
                        });
                });
